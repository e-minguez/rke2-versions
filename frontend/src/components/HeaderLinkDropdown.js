...
const RKE2VersionsLink = () => (
  <div className="flex flex-row items-center">
    ...
    <div className="ml-3 flex flex-col justify-center">
      <FontAwesomeIcon
        className="-mb-1 -mr-1 size-4 text-gray-400"
        aria-hidden="true"
        icon={faChevronUp}
      />
      <FontAwesomeIcon
        className="-mr-1 -mt-1 size-4 text-gray-400"
        aria-hidden="true"
        icon={faChevronDown}
      />
    </div>
